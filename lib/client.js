...
export default class Client extends EventEmitter {
	...
	getStartupConf() {
		...
		if (params.statement_timeout) {
			data.statement_timeout = `${params.statement_timeout}`;
		}

		if (params.lock_timeout) {
			data.lock_timeout = `${params.lock_timeout}`;
		}

		if (params.idle_in_transaction_session_timeout) {
			data.idle_in_transaction_session_timeout = `${params.idle_in_transaction_session_timeout}`;
		}
